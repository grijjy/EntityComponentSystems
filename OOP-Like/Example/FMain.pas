...
begin
  ...
  begin
    ...
    E.AddComponent(MakePosition(RandomCoord, RandomCoord, RandomCoord));
    E.AddComponent(MakeVelocity(RandomVel, RandomVel, RandomVel));

    { Add random Rotation and AngularVelocity components }
    E.AddComponent(MakeRotation(RandomAngle, RandomAngle, RandomAngle));
    E.AddComponent(MakeAngularVelocity(RandomAngVel, RandomAngVel, RandomAngVel));
    ...
    E.AddComponent<TDimensions>((Random * MAX_CUBE_SIZE) + 0.02);
    E.AddComponent<TMaterialIndex>(Random(CUBE_COLOR_COUNT));
